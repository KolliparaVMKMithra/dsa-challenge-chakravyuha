...
import { ShieldCheck, BarChart3, Users, FolderKanban, Megaphone, Search, Filter, Download, Plus, Pencil, Trash2, Calendar, RefreshCw, Send, Check, X, ShieldAlert, ArrowUpRight, Clock, Award, CheckCircle, Lock, User, AlertCircle, MessageSquare, Star, Terminal, Trophy, ChevronLeft, ChevronRight } from 'lucide-react';
